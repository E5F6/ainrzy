    ...
    return (
        <section className="w-full flex justify-center items-center px-5 py-36">
            <div className="flex flex-col justify-center items-center gap-3 w-[80vw] md:w-[60vw]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col justify-start items-center gap-3 p-5 rounded-md border-2 border-sky-600 mt-7">
                    ...
                    <button className="bg-sky-600 hover:bg-sky-700 transition ease-in-out px-5 py-2 font-medium text-xl text-slate-200 rounded-lg w-full">Signup</button>
                    <p className="font-medium self-start">Already Have an Account? <Link href="/account/login" className="underline text-sky-600">Login</Link></p>
                </form>
                {showSuccessMessage && (
                    <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center z-50">
                        <div className="card p-8 rounded-lg text-center">
                            ...
                            <button onClick={() => setShowSuccessMessage(false)} className="mt-4 bg-sky-600 hover:bg-sky-700 transition ease-in-out px-5 py-2 font-medium text-xl text-white rounded-lg">Close</button>
                        </div>
                    </div>
                )}
            </div>
