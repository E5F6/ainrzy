...
const Ecosystem = () => {
    ...
    return(
        <section className="w-full flex flex-col justify-center items-center">
            ...
            <h2 className="text-xl font-medium text-slate-300 text-center max-w-[900px]">AI Network is a decentralized AI development ecosystem open to all by gathering developers, GPUs, resources for development, and creator-based data in one place. It represents the future of collaborative AI to realize AI for everyone.</h2>
            ...
            {hellox.map((hello,index)=>(
                <div key={index} className="flex flex-col justify-center items-center gap-3">
                    ...
                    <h1 className="text-2xl font-semibold text-slate-200">{hello.text}</h1>
                    <h2 className="text-xl font-medium text-slate-300">{hello.text}</h2>
